...
- **Choose Open Science Desktop** if you want a local-first desktop app for macOS
  and Windows, with local files, notebook-style work, artifact provenance, and
...
| Primary surface | macOS and Windows desktop app | Browser workspace and `openscience` CLI |
...
| Platform fit | Researchers who want a desktop app, local files, private workspaces, and Windows/macOS support | Researchers who want browser workspace and CLI-first extensibility |
