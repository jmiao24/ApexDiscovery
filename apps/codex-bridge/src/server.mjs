...
- When a bundled Python API skill explicitly provides an ExecuteCode interface, follow it: load its read-only helper module in ExecuteCode and call its Python API instead of launching the helper CLI through native command execution.
